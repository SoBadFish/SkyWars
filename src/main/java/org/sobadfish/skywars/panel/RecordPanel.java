...
public class RecordPanel {
    ...
    public static void disPlayerMenu(Player player) {
        AdvancedFormWindowSimple simple = new AdvancedFormWindowSimple(TotalManager.GAME_NAME + " - 录像管理", "请选择您要进行的操作");
    ...
    public static void disRecordList(Player player) {
        AdvancedFormWindowSimple simple = new AdvancedFormWindowSimple(TotalManager.GAME_NAME + " - 录像列表", "请选择要操作的录像");
    ...
    public static void disRecordSearch(Player player) {
        AdvancedFormWindowCustom custom = new AdvancedFormWindowCustom(TotalManager.GAME_NAME + " - 录像查找");
    ...
    public static void disRecordInfo(Player player, File file) {
        AdvancedFormWindowSimple simple = new AdvancedFormWindowSimple(TotalManager.GAME_NAME + " - 录像详细信息");
